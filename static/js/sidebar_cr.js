document.addEventListener("DOMContentLoaded", function () {
    const sidebar = document.getElementById("sidebar-cr");
    const mainContainer = document.getElementById("main-container-cr");
    const toggleBtn = document.getElementById("toggle-btn-cr");
